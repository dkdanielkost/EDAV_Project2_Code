...
World map showing magnitude of deaths in 2003; run the mouse over the countries to see the country name and magnitude.
...
World map showing magnitude of displacments in 2003; run the mouse over the countries to see the country name and magnitude.
...
Google map with tagged flood locations from 1985-present; click a tag to see the date.
