...
We decided it would be interesting to examine a few specific flooding events in more detail. The two events occured on 2003-09-18 and 2003-11-19 and lasted for 7 and 4 days respectively. In the plots displayed below, the red events signify the flood events in the US corresponding with the annotated events above.
